        ...
        for distribution in distributions or [None]:
            ...
            if problem == 'tsp' or problem =='cvrp':
                if(opts.variation_type == 'graph_size'):
                    ...
                    for i in [10,15,20,25,30,35, 40,45, 50, 55, 60, 65]:
                        vrp_capacity = i
                        ...
                        filename = os.path.join(datadir, "{}_{}_size_{}_cap_vrp_{}_{}_seed{}.pkl".format(
                            problem,
                            "_{}".format(distribution) if distribution is not None else "",
                            opts.graph_size, str(vrp_capacity), opts.name, opts.seed))
